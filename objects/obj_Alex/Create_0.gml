...
_snesDiag = true; // Super Nintendo Diagonal will only display left or right directional sprites
...
_spd[1] = 2; // Normal movement speed
...
//--------------------------------------------
#region
_dir_8 = true; // If set to True the object can move in all 8 directions -- Grid Movement Only Variable
_tileSize = 8;
...
//--------------------------------------------
RPGState_ini();
RPGState_create("idle");
RPGState_create("walk");
RPGState_set("idle");
//Sub States
RPGSub_State_create("test");
RPGSub_State_set("test");
//--------------------------------------------